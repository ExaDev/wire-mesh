...
export const pathTraceSchema = z.lazy(() => z.object({
  "verb": z.literal("path.trace"),
}));
export const pathTraceOkSchema = z.lazy(() => z.object({
  "result": z.literal("ok"),
  "relayed": z.boolean(),
...
export const pongFrameSchema = z.lazy(() => z.object({
  "type": z.literal("pong"),
}));
